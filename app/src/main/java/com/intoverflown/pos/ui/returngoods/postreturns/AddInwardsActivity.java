...
import com.intoverflown.pos.databinding.ActivityAddInwardsBinding;
...
public class AddInwardsActivity extends AppCompatActivity {
    ...
    private ActivityAddInwardsBinding binding;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        binding = ActivityAddInwardsBinding.inflate(getLayoutInflater());
        ...
        binding.createReturnInwards.setOnClickListener(v -> {
            String url = Constants.BASE_URL + "ReturnInward/Create";
            createReturnInwards(url);
        });
    }

    private void createReturnInwards(String url) {
