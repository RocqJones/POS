...
//
////            "MerchantName": "Elen",
////                    "MerchantTypeId": "TypeB",
////                    "CountryId": "Kenya",
////                    "CreatedById": "1aadb13d-5252-47d6-a157-10e8892dbb57"
//
//            jsonObjects.put("MerchantName", "EEE");
//            jsonObjects.put("MerchantTypeId", "TypeA");
//            jsonObjects.put("CountryId", "KE");
//            jsonObjects.put("ContactPerson", "Jokkk");
//            jsonObjects.put("CreatedById", uid);
//
//            array = new JSONArray("["+jsonObjects.toString()+"]");
//
//            Log.d("TAG" + "SAMPLE", array.toString());
//        } catch (final JSONException e) {
//            e.printStackTrace();
//
//        }
...
//                    } catch (Exception e) {
//
//                        Toast.makeText(NewBranchActivity.this, Log.getStackTraceString(e) + "",
